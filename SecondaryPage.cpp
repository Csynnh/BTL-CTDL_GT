...
SecondaryPage::SecondaryPage(int num) : m_blocks("second"), m_texts("second")
{
	...
	// set film's name
	m_texts.AddTextContainer(x.a[filmIndex].name, fontFilmName, 30, Color::Black, xPosInfo, 113);
	// set film's category
	m_texts.AddTextContainer("The loai:", fontTitle, 18, Color::Black, xPosInfo, 150);
	// set film's category content
	m_texts.AddTextContainer(x.a[filmIndex].type, fontDesc, 16, Color::Black, xPosInfo + 85, 150 + 2);
	// set film's time
	m_texts.AddTextContainer("Thoi luong:", fontTitle, 18, Color::Black, xPosInfo, 172);
	// set film's time content
	m_texts.AddTextContainer(x.a[filmIndex].time, fontDesc, 16, Color::Black, xPosInfo + 110, 172 + 2);
	// set film's language
	m_texts.AddTextContainer("Ngon ngu:", fontTitle, 18, Color::Black, xPosInfo, 193);
	// set film's language content
	m_texts.AddTextContainer(x.a[filmIndex].language, fontDesc, 16, Color::Black, xPosInfo + 102, 193 + 2);
	// set film's Rate
	m_texts.AddTextContainer("Danh gia:", fontTitle, 18, Color::Black, xPosInfo, 215);
	// set film's Rate content
	m_texts.AddTextContainer(x.a[filmIndex].rating, fontDesc, 16, Color::Black, xPosInfo + 95, 215 + 2);
	// set film's Date
	...
	m_texts.AddTextContainer(x.a[filmIndex].director, fontDesc, 16, Color::Black, xPos + 95, 340 + 2);
	// set film's actor
