...
ThirdTab::ThirdTab(int num) : m_blocks("second"), m_texts("second")
{
	...
	m_texts.AddTextContainer("Rap Chieu", fontTitle, 17, Color::Black, 248, 95);
	m_texts.AddTextContainer("Thong Tin", fontTitle, 17, Color::White, 380, 95);
	//
	m_texts.AddTextContainer("SLC2T", fontFilmName, 50, Color::Red, 212, 25);
	// thong tin
	m_blocks.AddBlockContainer(bg_rap, xbgRap, ybgRap, 1, 1);
	m_texts.AddTextContainer("Vo Cong Sinh ( Leader ) ", fontTitle, 20, Color::Black, 178, 192);
	m_texts.AddTextContainer("MSSV: 6351071062 ", fontTitle, 20, Color::Black, 200, 224);

	m_blocks.AddBlockContainer(bg_rap, xbgRap, 326, 1, 1);
	m_texts.AddTextContainer("Huynh Thi Truc Lam ( Thanh vien ) ", fontTitle, 20, Color::Black, 150, 350);
	m_texts.AddTextContainer("MSSV: 6351071040", fontTitle, 20, Color::Black, 203, 379);

	m_blocks.AddBlockContainer(bg_rap, xbgRap, 473, 1, 1);
	m_texts.AddTextContainer("Pham Luc Chuong ( Thanh vien ) ", fontTitle, 20, Color::Black, 159, 489);
	m_texts.AddTextContainer("MSSV: 6351071008", fontTitle, 20, Color::Black, 203, 518);

	m_blocks.AddBlockContainer(bg_rap, xbgRap, 621, 1, 1);
	m_texts.AddTextContainer("Dang Thi Kim Thao ( Thanh vien ) ", fontTitle, 20, Color::Black, 158, 637);
	m_texts.AddTextContainer("MSSV: 6351071066", fontTitle, 20, Color::Black, 203, 667);

	m_blocks.AddBlockContainer(bg_rap, xbgRap, 769, 1, 1);
	m_texts.AddTextContainer("Nguyen Trung Tin ( Thanh vien ) ", fontTitle, 20, Color::Black, 153, 785);
	m_texts.AddTextContainer("MSSV: 6351071070", fontTitle, 20, Color::Black, 203, 815);
}
