...
SecondTab::SecondTab(int num) : m_blocks("second"), m_texts("second")
{
	...
	m_texts.AddTextContainer("BHD Star Le Van Viet ", fontTitle, 20, Color::Black, 189, 192);
	m_texts.AddTextContainer("Vincom Plaza, Le Van Viet, Hiep Phu, Quan 9, ", fontDesc, 14, Color::Black, 135, 224);
	m_texts.AddTextContainer("Thanh pho Ho Chi Minh, Viet Nam ", fontDesc, 14, Color::Black, 185, 246);

	m_blocks.AddBlockContainer(bg_rap, xbgRap, 326, 1, 1);
	m_texts.AddTextContainer("Cinestar Sinh Vien ", fontTitle, 20, Color::Black, 206, 350);
	m_texts.AddTextContainer("8, 19, Binh Duong, Viet Nam", fontDesc, 14, Color::Black, 203, 379);

	m_blocks.AddBlockContainer(bg_rap, xbgRap, 473, 1, 1);
	m_texts.AddTextContainer("CGV Vincom Thu Duc ", fontTitle, 20, Color::Black, 189, 489);
	m_texts.AddTextContainer("216 Vo Van Ngan, Binh Tho", fontDesc, 14, Color::Black, 203, 518);
	m_texts.AddTextContainer(" Thu Duc, Thanh pho Ho Chi Minh, Viet Nam", fontDesc, 14, Color::Black, 135, 540);

	m_blocks.AddBlockContainer(bg_rap, xbgRap, 621, 1, 1);
	m_texts.AddTextContainer("CGV Vincom Giga Mall Thu Duc ", fontTitle, 20, Color::Black, 137, 637);
	m_texts.AddTextContainer("Tang 6 TTTM Giga Mall, 240, 242 Pham Van Dong, Hiep Binh Chanh", fontDesc, 14, Color::Black, 60, 667);
	m_texts.AddTextContainer(" Thu Duc, Thanh pho Ho Chi Minh, Viet Nam", fontDesc, 14, Color::Black, 145, 689);
